  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container max-w-4xl">
        ...
        {/* Formulario */}
        <div className="bg-white rounded-lg border border-gray-100 p-8 mb-10 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-white border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 rounded-lg bg-white border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition min-h-[100px] resize-none"
            ...
            <div className="bg-purple-50 rounded-lg p-4 border border-purple-200/60">
          ...
          {transmisiones.length > 0 ? (
            <div className="space-y-4">
              {transmisiones.map(t => (
                <div
                  key={t.id}
                  className="group bg-white rounded-lg border border-gray-200 p-6 hover:border-gray-300 shadow-sm transition-all"
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {t.activa && (
                          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-red-100 text-red-700 text-xs font-semibold animate-pulse">
                      ...
                      <p className="text-sm text-gray-700 mb-3 line-clamp-1 font-light">
                        {t.descripcion}
                      </p>

                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                        <div>
                          <p className="text-gray-500">Predicador</p>
                          <p className="font-light text-gray-900">{t.predicador || '—'}</p>
                        </div>
                        <div>
                          <p className="text-gray-500">Fecha</p>
                          <p className="font-light text-gray-900">{formatDate(t.fechaInicio).split(' ')[0]}</p>
                        </div>
                        <div>
                          <p className="text-gray-500">Duración</p>
                          <p className="font-light text-gray-900">{t.duracion ? `${t.duracion} min` : '—'}</p>
                        </div>
                        <div>
                          <p className="text-gray-500">Enlace</p>
                          <p className="font-light text-gray-900">{t.enlaceZoom ? '✓' : '✗'}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-blue-100 text-blue-700 text-sm hover:bg-blue-200 transition font-light"
                      >
                        ✏️
                      </button>
                      <button
                        onClick={() => handleDelete(t.id)}
                        className="px-3 py-1.5 rounded-lg bg-red-100 text-red-700 text-sm hover:bg-red-200 transition font-light"
                      >
                        🗑️
                      </button>
                    </div>
            ...
            <div className="p-12 rounded-lg border border-dashed border-gray-300 text-center bg-white">
              <p className="text-gray-600 font-light">
