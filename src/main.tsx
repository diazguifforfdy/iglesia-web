...
import Himnarios from './pages/Himnarios'
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'servicios/himnarios', element: <Himnarios /> },
      { path: 'admin/login', element: <AdminLogin /> },
      {
        ...
        children: [
          ...
          { path: 'calendario', element: <CalendarAdmin /> },
          { path: 'multimedia', element: <MediaAdmin /> },
          { path: 'biblioteca', element: <BibliotecaAdmin /> },
          { path: 'audios', element: <AudioAdmin /> },
          {
            path: 'comentarios',
            element: (
          ...
          { path: 'donaciones', element: <DonacionesAdmin /> },
          { path: 'transmisiones', element: <TransmisionesAdmin /> }
        ]
      },
      { path: 'servicios/:slug', element: <Service /> },
