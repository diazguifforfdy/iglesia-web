...
export default function WhatsAppButton() {
  ...
  return (
    <a
      href={href}
      onClick={handleClick}
      className="fixed bottom-6 right-6 bg-green-500 text-white rounded-full px-4 py-3 shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-105 active:scale-95 flex items-center gap-2"
    ...
    >
      ...
      WhatsApp
      {isSending && <span className="text-xs opacity-75">Enviando...</span>}
    </a>
  )
}
