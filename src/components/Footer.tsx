      ...
      <div className="container py-10 grid gap-6 md:grid-cols-3 items-center">
        ...
        <div className="order-1 md:order-2 flex flex-col items-center gap-2">
          <a
            ...
            className="group inline-flex items-center gap-2 text-sm text-gray-300 hover:text-gold transition-colors"
            aria-label="Abrir ubicación en Google Maps"
            title="Ver ubicación"
          >
            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full ring-1 ring-white/20 text-gray-300 group-hover:text-primary group-hover:bg-gold transition">
